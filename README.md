...
This repo provides build files for [schema-registry](https://www.confluent.io/confluent-schema-registry) Docker images.
...
- *CONFLUENT_PACKAGES_REPO*: (Required) Specify the location of the Confluent Platform packages repository. Depending on the type of OS for the image you are building you will need to either provide a Debian or RPM repository. For example this is the repository for the 8.1.0 release of the Debian packages: `https://packages.confluent.io/deb/8.1`. This is the repository for the 8.1.0 release of the RPM's: `https://packages.confluent.io/rpm/8.1`
- *CONFLUENT_VERSION*: (Required) Specify the full Confluent Platform release version. Example: 8.1.0
